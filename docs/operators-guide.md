...
This endpoint includes documentation and type-information for each metric. More on Prometheus metric types conventions can be found [here](https://prometheus.io/docs/concepts/metric_types).
